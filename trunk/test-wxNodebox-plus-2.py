...
class TestPanel(wx.Panel):
    ...
    def Render(self, dc):
        ...
        #ctx.rotate(40)
        #ctx.rect(30, 60, 40, 40)
        #ctx.cairoContext.translate( x, y)
        #ctx.cairoContext.rectangle( 30, 60, 40, 40)
        transform = 'CENTER'
        ctx.cairoContext.translate( 30+30/2.,60+60/2.)
        ctx.cairoContext.rotate( 90 / (pi/2.))
        #ctx.cairoContext.rotate( 90)
        ctx.cairoContext.rectangle( -30/2., -60/2., 40, 40)
